        ...
        <table class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">
                        <a href="?sort_name=name&sort_val={{$sort}}">Nama
                    ...
                    <th scope="col">
                        <a href="?sort_name=description&sort_val={{$sort}}">Deskripsi
                            @if (request('sort_name')=='description' && request('sort_val')=='ASC')
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-sort-up" viewBox="0 0 16 16">
                                <path
                                    d="M3.5 12.5a.5.5 0 0 1-1 0V3.707L1.354 4.854a.5.5 0 1 1-.708-.708l2-1.999.007-.007a.498.498 0 0 1 .7.006l2 2a.5.5 0 1 1-.707.708L3.5 3.707V12.5zm3.5-9a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zM7.5 6a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5zm0 3a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1h-3zm0 3a.5.5 0 0 0 0 1h1a.5.5 0 0 0 0-1h-1z" />
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-warning btn-sm" href="/group/{{$item->id}}">
                            <span data-feather="eye"></span>
                        </a>
                        <a class="btn btn-primary btn-sm" href="/group/{{$item->id}}/edit">
                            <span data-feather="edit"></span>
                        </a>

                        <a class="btn btn-danger btn-sm" href="javascript:" onclick="deleteData({{$item->id}})"><span
                                data-feather="trash"></span></a>
                        <form class="d-none" id="formdelete-{{$item->id}}" action="/group/{{$item->id}}" method="POST">
                            @method('DELETE')
                            @csrf
                        </form>
                    </td>
